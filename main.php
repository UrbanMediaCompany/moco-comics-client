...
<html lang="es" itemscope itemtype="http://schema.org/WebPage">
	...
	<head prefix="og: http://ogp.me/ns#">
		...
		<title>Moco-Comics - Monitos de Juanele</title>

		<meta charset="UTF-8">
		<meta name="viewport" content="width=device-width, initial-scale=1">
		<meta name="description" content="Moco-Comics, Monitos de Juanele">
		<meta name="keywords" content="moco, comics, juanele, patote, tilinia, chonito, abuela, karateka, cuco, pepo">
		...
		<meta property="og:description" content="Moco-Comics, Monitos de Juanele"/>
		<meta property="og:site_name" content="Moco Comics"/>
		<meta property="og:url" content="http://moco-comics.com"/> <!--The Web main URL-->
		<meta property="og:title" content="Moco-Comics - Monitos de Juanele"/>

		<!--Google Meta Tags-->
		<meta itemprop="name" content="Moco-Comics - Monitos de Juanele">
		<meta itemprop="description" content="Moco-Comics, Monitos de Juanele">
		...
		<meta name="twitter:title" content="Moco-Comics - Monitos de Juanele">
		<meta name="twitter:description" content="Moco-Comics, Monitos de Juanele">
	...
	<body>
		...
		<section class="featured">
			<div class="container clearfix">
				<h5 class="section-title">Lo más nuevo</h5>
				<?php
                    echo $custom->getLatest();
                ?>
			</div>
			<div class="ads">
		...
		<section class="blog" id="blog">
			<div class="sd-l-aside-wrapper column sd-l4 md3 ">
				<nav class="posts-navigation">

								<?php
                                    $routes = $_->getRoute();
                                    if(@$routes[1]=="page" && @$routes[2]!=""){
                                        $value = intval($routes[2]);
                                        $init = ($value*4)-3;
                                        echo $custom->buildNavigation($init,$value);
                                    }else{
                                       echo $custom->buildNavigation(0);
                                    }
				...
				<div class="paypal-donation">
					<p>Si te gustan mis cómics puedes apoyar con una donación, ¡grashiash!</p>
					<button class="donations">
			...
			<div class="container clearfix">
				<?php
                    ...
                    if(@$routes[1]=="page" && @$routes[2]!=""){
                        ...
                        echo $custom->printPosts($init,4);
                    }else{
                       echo $custom->printPosts(0,4);
                    }
            ...
            <?php
                    //echo "<p><span>Ir a la Página: </span>".$custom->buildNonscriptNavigation()."</p>";
                ?>
		</section>

		<section class="js-responsive-aid">
			<div class="mobile-donation sd-invisible">
					<div class="paypal-donation xsd-visible">
						<p>Si te gustan mis cómics puedes apoyar con una donación, ¡grashiash!</p>
						<button class="donations">
							<form action="https://www.paypal.com/cgi-bin/webscr" method="post" target="_blank" class="paypal-form">
								<input type="hidden" name="cmd" value="_s-xclick">
