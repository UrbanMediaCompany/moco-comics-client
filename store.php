...
<html lang="es" itemscope itemtype="http://schema.org/WebPage">
	...
	<head prefix="og: http://ogp.me/ns#">
		...
		<title>Tienda | Moco-Comics - Monitos de Juanele</title>

		<meta charset="UTF-8">
		<meta name="viewport" content="width=device-width, initial-scale=1">
		<meta name="description" content="Aquí está los tomos que tenemos disponibles en este momento.">
		<meta name="keywords" content="comics, moco, juanele, monitos, tienda">
		<meta name="author" content="Moco Comics">
		<base href="<?php echo $custom->config->web_domain; ?>" >

		<!--Facebook Meta Tags-->
		<meta property="og:image" content="http://moco-comics.com/img/store/2015-01-05-Banner-Enero-2.jpg"/>
		<meta property="og:description" content="Aquí están los tomos que tenemos disponibles en este momento."/>
		<meta property="og:site_name" content="Tienda"/>
		<meta property="og:url" content="http://www.moco-comics.com/tienda/"/>
		<meta property="og:title" content="Tienda | Moco-Comics - Monitos de Juanele"/>

		<!--Google Meta Tags-->
		<meta itemprop="name" content="Tienda | Moco-Comics - Monitos de Juanele">
		<meta itemprop="description" content="Aquí están los tomos que tenemos disponibles en este momento.">
		<meta itemprop="image" content="http://moco-comics.com/img/store/2015-01-05-Banner-Enero-2.jpg">

		<!--Twitter Meta Tags-->
		<meta name="twitter:card" content="summary_large_image">
        <meta name="twitter:domain" content="moco-comics.com">
		<meta name="twitter:site" content="@juanele_tamal">
		<meta name="twitter:title" content="Tienda | Moco-Comics - Monitos de Juanele">
		<meta name="twitter:description" content="Aquí están los tomos que tenemos disponibles en este momento.">
		<meta name="twitter:creator" content="@juanele_tamal">
		<meta name="twitter:image:src" content="http://moco-comics.com/img/store/2015-01-05-Banner-Enero-2.jpg">
	...
	<body>
		...
		<section class="store">
			<div class="container">
                <p><?php echo $custom->getAdditionalData("Store Description"); ?></p>
				<div class="items-wrapper">

						<?php
                            echo $custom->buildStore();
                        ?>
                    <form id="store" method="post">
						<div class="user-info">
							...
							<textarea placeholder="Comentarios, en que comics estas interesado?" name="comments"></textarea>
